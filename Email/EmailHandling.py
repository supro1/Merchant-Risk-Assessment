...
class EmailSender:
    __sender_email_id = "bikproml@rediffmail.com"
    __receiver_email_id = "bikproml@rediffmail.com"
    __password = "bikproml"
    ...
    def sendEmail(self, mail_text, subject):
        ...
        try:
            ...
            with smtplib.SMTP_SSL("smtp.rediffmail.com", 465, context=context) as server:
