...
class AzureBlobManagement:
    ...
    __connection_string = "DefaultEndpointsProtocol=https;AccountName=waffer0;AccountKey=9hdZPGP0PAeSvzugNi5eisZ0GSTE/93gYY2BO0sPObfT9ZQqyXWQefmSgs79AF/nxlsEHaqQag2yhlhe5P08mQ==;EndpointSuffix=core.windows.net"
